...
//---------------------------------------------------------------------------------------------
    ...
    Window_QuestInfo.prototype.drawQuestSteps = function(q) {
        ...
        this.questBitmap.textColor = this.systemColor(); 
        this.questBitmap.drawText("Текущее задание", 0, this.lineY, this.contentsWidth(), this.lineHeight());
        this.write();
        this.questBitmap.textColor = this.normalColor();
    ...
    Window_QuestInfo.prototype.drawQuestRewards = function(q) {
        ...
        // Draw Rewards
        this.questBitmap.textColor = this.systemColor(); 
        this.questBitmap.drawText("Награда", 0, this.lineY, this.contentsWidth(), this.lineHeight());
        this.write();
        this.questBitmap.textColor = this.normalColor();
...
//---------------------------------------------------------------------------------------------
    ...
    Window_QuestFilter.prototype.initialize = function() {
        this.qFilters = [
            ...
            GameusScripts["Config"]["QuestSystem"]["Progress Word"] || "Действующие",
